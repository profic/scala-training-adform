...
//      })
//
//    search(ranges, ipToLong(InetAddress.getByName("92.173.0.104")))
//
//    println(searchCnt)
//    println(lookupCnt)
//
...
//      else {
//        val i = subTree.value
//        val overlaps: Boolean = key >= i.begin && key <= i.end
//        val _acc: List[E] = if (overlaps) i.data :: acc else acc
//        val leftResult = helper(subTree.left, key, _acc)
//
//        if (key >= i.begin) helper(subTree.right, key, leftResult)
//        else leftResult
//      }
//    }
