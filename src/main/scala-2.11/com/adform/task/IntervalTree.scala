...
class IntervalTree[I <: Interval](_intervals: List[I])(implicit ord: Ordering[I]) {
...
//    private def findContainingIntervals(x: Double, a: Int, b: Int): List[I] = {
//      def helper(_x: Double, _a: Int, _b: Int, result: mutable.ArrayBuffer[I]) {
//        if (_a >= _b) {
//          return
//        }
//        val m: Int = (_a + _b) >>> 1
