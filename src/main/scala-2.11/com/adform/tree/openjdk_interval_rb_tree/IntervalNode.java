...
public class IntervalNode extends RBNode {
  ...
  IntervalNode(Interval interval, Comparator endpointComparator, Object data) {
    super(data);
  ...
  Object getMinEndpoint() {
    return minEndpoint;
  }

  Object getMaxEndpoint() {
    return maxEndpoint;
  }
